...
| `GOOGLE_CSE_PAGINAS_POR_QUERY` | não | Quantas páginas do widget (10 resultados cada) o crawler pagina por query, com delay aleatório de 2.5–6s entre cliques pra reduzir risco de bloqueio. Padrão `5`, teto `10` (o widget não lista mais que isso). Cada busca continua contando como 1 unidade no `GOOGLE_CSE_DAILY_LIMIT`, independente de quantas páginas lê. |
